...
namespace Microsoft.Maui.Handlers
{
	public partial class ScrollViewHandler : ViewHandler<IScrollView, ScrollViewer>
	{
		...
		/*
			The Win App SDK ScrollViewer treats Padding differently than we want for MAUI. The Padding creates space
			_around_ the scrollable area, rather than padding the content inside of it. Also, the ScrollViewer will 
			force any content to start at the origin (0,0), even if we ask to arrange it at an offset. This defeats
			our content's Margin properties. 
